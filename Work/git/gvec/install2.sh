...
git clone git@gitlab.mpcdf.mpg.de:gvec-group/gvec.git pygvec
cd pygvec
pip install git+ssh://git@gitlab.mpcdf.mpg.de/gvec-group/gvec.git --config-settings=cmake.define.CMAKE_HOSTNAME=tokp --config-settings=cmake.define.USE_OPENMP=Off
