...
contains
  ...
  function to_s_complex_ (value)
    ...
    complex(kind=kind(1.0E0_4)), intent(in) :: value
    character(len=500) :: result
    write (result, *) value
  ...
  function equalEpsilon (number1, number2, epsilon ) result (resultValue)
    real*4, intent (in) :: number1, number2, epsilon 
    logical :: resultValue 
  ...
  function floatEqual (number1, number2 ) result (resultValue)
    real*4, intent (in) :: number1, number2
    real*4 :: epsilon 
    logical :: resultValue 
...
999 continue
  ...
  subroutine assert_eq_1d_real_(var1, var2, n, message)
    integer, intent (in) :: n
    integer              :: i
    real*4, intent (in) :: var1(n), var2(n)
  ...
  subroutine assert_eq_2d_real_(var1, var2, n, m, message)
    integer, intent (in) :: n, m
    integer              :: i, j
    real*4, intent (in) :: var1(n, m), var2(n, m)
